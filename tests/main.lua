...
prepfile[[
warn("@allow")
-- create two objects to be finalized when closing interpreter
...
-- bug since 5.2: finalizer called when closing a interpreter could
...
if T then   -- test library?
  print("testing 'not enough memory' to create a interpreter")
