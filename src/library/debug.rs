...
pub unsafe extern "C" fn db_setmetatable(interpreter: *mut Interpreter) -> i32 {
    unsafe {
        ...
        (((t == Some(TagType::Nil) || t == Some(TagType::Table)) as i32 != 0) as i64 != 0
            || lual_typeerror(interpreter, 2, b"nil or table\0" as *const u8 as *const libc::c_char) != 0)
            as i32;
    ...
    unsafe {
        ...
        (((*options.offset(0 as isize) as i32 != CHARACTER_ANGLE_RIGHT as i32) as i32 != 0) as i64 != 0
            || lual_argerror(
                interpreter,
                arg + 2,
                b"invalid option CHARACTER_ANGLE_RIGHT\0" as *const u8 as *const libc::c_char,
            ) != 0) as i32;
        if lua_type(interpreter, arg + 1) == Some(TagType::Closure) {
            options = lua_pushfstring(interpreter, b">%s\0" as *const u8 as *const libc::c_char, options);
        ...
        if !(strchr(options, CHARACTER_UPPER_S as i32)).is_null() {
            ...
            lua_setfield(interpreter, -2, b"source\0" as *const u8 as *const libc::c_char);
            settabss(
                interpreter,
            ...
            settabss(interpreter, b"what\0" as *const u8 as *const libc::c_char, ar.what);
        }
        ...
        if !(strchr(options, CHARACTER_LOWER_U as i32)).is_null() {
            settabsi(interpreter, b"nups\0" as *const u8 as *const libc::c_char, ar.nups as i32);
            settabsi(
                interpreter,
        ...
        if !(strchr(options, CHARACTER_LOWER_N as i32)).is_null() {
            settabss(interpreter, b"name\0" as *const u8 as *const libc::c_char, ar.name);
            settabss(interpreter, b"namewhat\0" as *const u8 as *const libc::c_char, ar.namewhat);
        }
        ...
        if !(strchr(options, CHARACTER_UPPER_L as i32)).is_null() {
            treatstackoption(
                interpreter,
                other_state,
                b"activelines\0" as *const u8 as *const libc::c_char,
            );
        }
        if !(strchr(options, CHARACTER_LOWER_F as i32)).is_null() {
            treatstackoption(interpreter, other_state, b"func\0" as *const u8 as *const libc::c_char);
        }
        return 1;
    }
}
pub unsafe extern "C" fn db_getlocal(interpreter: *mut Interpreter) -> i32 {
    unsafe {
        ...
        if lua_type(interpreter, arg + 1) == Some(TagType::Closure) {
            ...
            let name: *const libc::c_char = lua_getlocal(other_state, &mut ar, nvar);
            if !name.is_null() {
...
pub unsafe extern "C" fn db_sethook(interpreter: *mut Interpreter) -> i32 {
    unsafe {
        ...
        match lua_type(interpreter, arg + 1) {
            ...
            _ => {
                let smask: *const libc::c_char = lual_checklstring(interpreter, arg + 2, null_mut());
        ...
        if lual_getsubtable(interpreter, -(1000000 as i32) - 1000 as i32, HOOKKEY) == 0 {
            lua_pushstring(interpreter, b"k\0" as *const u8 as *const libc::c_char);
            lua_setfield(interpreter, -2, b"__mode\0" as *const u8 as *const libc::c_char);
...
pub unsafe extern "C" fn db_gethook(interpreter: *mut Interpreter) -> i32 {
    unsafe {
        ...
        if hook.is_none() {
            ...
            lua_pushstring(interpreter, b"external hook\0" as *const u8 as *const libc::c_char);
        } else {
...
pub unsafe extern "C" fn db_debug(interpreter: *mut Interpreter) -> i32 {
    unsafe {
        loop {
            ...
            if (fgets(
                buffer.as_mut_ptr(),
                ::core::mem::size_of::<[libc::c_char; 250]>() as i32,
                stdin,
            ))
            .is_null()
...
pub unsafe extern "C" fn db_traceback(interpreter: *mut Interpreter) -> i32 {
    unsafe {
        let mut arg: i32 = 0;
        let other_state: *mut Interpreter = getthread(interpreter, &mut arg);
        let message: *const libc::c_char = lua_tolstring(interpreter, arg + 1, null_mut());
