...
pub unsafe extern "C" fn lua_gc(state: *mut State, what: i32, args: ...) -> i32 {
    unsafe {
        ...
        match what {
            ...
            4 => {
                res = (((*g).totalbytes + (*g).gc_debt) as u64 & 0x3ff as u64) as i32;
            }
            5 => {
...
pub unsafe extern "C" fn close_state(state: *mut State) {
    unsafe {
        ...
        freestack(state);
        raw_allocate(
            (state as *mut u8).offset(-(8 as isize)) as *mut LX as *mut libc::c_void,
...
pub unsafe extern "C" fn luae_freethread(state: *mut State, other_state: *mut State) {
    unsafe {
        let l: *mut LX = (other_state as *mut u8).offset(-(8 as isize)) as *mut LX;
...
pub unsafe extern "C" fn lua_newstate() -> *mut State {
    unsafe {
        ...
        (*g).totalbytes = ::core::mem::size_of::<LG>() as i64;
        (*g).gc_debt = 0;
        (*g).lastatomic = 0;
...
pub unsafe extern "C" fn l_str2d(s: *const i8, result: *mut f64) -> *const i8 {
    unsafe {
        ...
        if endptr.is_null() {
            ...
            if pdot.is_null() || strlen(s) > 200 as u64 {
                return std::ptr::null();
            }
...
pub unsafe extern "C" fn dump_header(dump_state: *mut DumpState) {
    unsafe {
        ...
        dump_integer(dump_state, 0x5678 as i64);
