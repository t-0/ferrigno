...
pub unsafe extern "C" fn index2value(state: *mut State, mut index: i32) -> *mut TValue { unsafe {
    ...
    if index > 0 {
        ...
        if (*(*call_info).function.p).val.tag == TAG_TYPE_CLOSURE_C | TAG_COLLECTABLE {
...
pub unsafe extern "C" fn lua_iscfunction(state: *mut State, index: i32) -> bool { unsafe {
    let o: *const TValue = index2value(state, index);
    return (*o).tag == TAG_TYPE_CLOSURE_CFUNCTION || (*o).tag == TAG_TYPE_CLOSURE_C | TAG_COLLECTABLE;
}}
#[unsafe(no_mangle)]
...
pub unsafe extern "C" fn lua_isstring(state: *mut State, index: i32) -> bool { unsafe {
    let o: *const TValue = index2value(state, index);
    return (*o).tag & TAG_TYPE_MASK_ == 4 || (*o).tag & TAG_TYPE_MASK_ == 3;
}}
#[unsafe(no_mangle)]
...
pub unsafe extern "C" fn lua_toboolean(state: *mut State, index: i32) -> i32 { unsafe {
    let o: *const TValue = index2value(state, index);
    return !((*o).tag == TAG_TYPE_BOOLEAN_FALSE || (*o).tag & TAG_TYPE_MASK_ == 0)
        as i32;
}}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn lua_tolstring(
    ...
    if !((*o).tag & TAG_TYPE_MASK_ == TAG_TYPE_STRING) {
        if !((*o).tag & TAG_TYPE_MASK_ == TAG_TYPE_NUMERIC) {
            if !length.is_null() {
                *length = 0;
            }
            return std::ptr::null();
...
pub unsafe extern "C" fn lua_tocfunction(state: *mut State, index: i32) -> CFunction { unsafe {
    ...
    if (*o).tag == TAG_TYPE_CLOSURE_CFUNCTION {
        return (*o).value.f;
    } else if (*o).tag == TAG_TYPE_CLOSURE_C | TAG_COLLECTABLE {
...
pub unsafe extern "C" fn lua_tothread(state: *mut State, index: i32) -> *mut State { unsafe {
    let o: *const TValue = index2value(state, index);
    return if !((*o).tag == TAG_TYPE_STATE | TAG_COLLECTABLE) {
        std::ptr::null_mut()
    } else {
...
pub unsafe extern "C" fn lua_pushcclosure(state: *mut State, fn_0: CFunction, mut n: i32) { unsafe {
    if n == 0 {
        let io: *mut TValue = &mut (*(*state).top.p).val;
        (*io).value.f = fn_0;
        (*io).tag = (TAG_TYPE_CLOSURE_CFUNCTION) as u8;
        (*state).top.p = (*state).top.p.offset(1);
        (*state).top.p;
    } else {
        ...
        (*io_0).tag = (TAG_TYPE_CLOSURE_C | TAG_COLLECTABLE) as u8;
        (*state).top.p = (*state).top.p.offset(1);
        (*state).top.p;
        if (*(*state).global).gc_debt > 0 {
            luac_step(state);
...
pub unsafe extern "C" fn lua_pushthread(state: *mut State) -> bool { unsafe {
    ...
    (*io).value.gc = &mut (*(x_ as *mut GCUnion)).gc;
    (*io).tag = (TAG_TYPE_STATE | TAG_COLLECTABLE) as u8;
    (*state).top.p = (*state).top.p.offset(1);
    (*state).top.p;
...
pub unsafe extern "C" fn auxgetstr(
    ...
    if if !((*t).tag == TAG_TYPE_TABLE | TAG_COLLECTABLE) {
        slot = std::ptr::null();
        0
    } else {
        slot = luah_getstr(&mut (*((*t).value.gc as *mut GCUnion)).h, str);
        !((*slot).tag & TAG_TYPE_MASK_ == 0) as i32
    } != 0
    {
        let io1: *mut TValue = &mut (*(*state).top.p).val;
    ...
    return ((*(*state).top.p.offset(-(1 as isize))).val.tag & TAG_TYPE_MASK_) as i32;
}}
#[unsafe(no_mangle)]
...
pub unsafe extern "C" fn lua_createtable(state: *mut State, narray: i32, nrec: i32) { unsafe {
    ...
    let x_: *mut Table = t;
    (*io).value.gc = &mut (*(x_ as *mut GCUnion)).gc;
    (*io).tag = (TAG_TYPE_TABLE | TAG_COLLECTABLE) as u8;
    (*state).top.p = (*state).top.p.offset(1);
    (*state).top.p;
    if narray > 0 || nrec > 0 {
...
pub unsafe extern "C" fn lua_getmetatable(state: *mut State, objindex: i32) -> i32 { unsafe {
    ...
    match (*obj).get_tag_type() {
        ...
        _ => {
            mt = (*(*state).global).mt[((*obj).tag & TAG_TYPE_MASK_) as usize];
        }
    }
    if mt.is_null() {
        0
...
pub unsafe extern "C" fn lua_getiuservalue(state: *mut State, index: i32, n: i32) -> i32 { unsafe {
    ...
    if n <= 0 || n > (*((*o).value.gc as *mut GCUnion)).u.nuvalue as i32 {
        ...
        (*io1).value = (*io2).value;
        (*io1).tag = (*io2).tag;
        t = ((*(*state).top.p).val.tag & TAG_TYPE_MASK_) as i32;
    }
    (*state).top.p = (*state).top.p.offset(1);
    (*state).top.p;
    return t;
...
pub unsafe extern "C" fn auxsetstr(state: *mut State, t: *const TValue, k: *const i8) { unsafe {
    ...
    } != 0
    {
        ...
        (*io1).value = (*io2).value;
        (*io1).tag = (*io2).tag;
        if (*(*state).top.p.offset(-(1 as isize))).val.tag & TAG_COLLECTABLE != 0 {
...
pub unsafe extern "C" fn lua_setmetatable(state: *mut State, objindex: i32) -> i32 { unsafe {
    ...
    if (*(*state).top.p.offset(-(1 as isize))).val.tag & TAG_TYPE_MASK_ == 0 {
        mt = std::ptr::null_mut();
    } else {
        mt = &mut (*((*(*state).top.p.offset(-(1 as isize))).val.value.gc as *mut GCUnion)).h;
    }
    match (*obj).tag & TAG_TYPE_MASK_ {
        5 => {
        ...
        _ => {
            (*(*state).global).mt[((*obj).tag & TAG_TYPE_MASK_) as usize] = mt;
        }
    }
    (*state).top.p = (*state).top.p.offset(-1);
    (*state).top.p;
...
pub unsafe extern "C" fn lua_dump(
    ...
    if (*o).tag == TAG_TYPE_CLOSURE_L | TAG_COLLECTABLE {
        status = luau_dump(
            state,
...
pub unsafe extern "C" fn lua_error(state: *mut State) -> i32 { unsafe {
    ...
    if (*errobj).tag == TAG_TYPE_STRING_SHORT | TAG_COLLECTABLE
...
pub unsafe extern "C" fn lua_newuserdatauv(
    ...
    let x_: *mut Udata = u;
    (*io).value.gc = &mut (*(x_ as *mut GCUnion)).gc;
    (*io).tag = (TAG_TYPE_USER | TAG_COLLECTABLE) as u8;
    (*state).top.p = (*state).top.p.offset(1);
    (*state).top.p;
    if (*(*state).global).gc_debt > 0 {
        luac_step(state);
...
pub unsafe extern "C" fn init_registry(state: *mut State, g: *mut Global) { unsafe {
    ...
    (*io_0).tag = (TAG_TYPE_STATE | TAG_COLLECTABLE) as u8;
    let io_1: *mut TValue =
    ...
    (*io_1).tag = (TAG_TYPE_TABLE | TAG_COLLECTABLE) as u8;
}}
...
pub unsafe extern "C" fn close_state(state: *mut State) { unsafe {
    let g: *mut Global = (*state).global;
    if !((*g).nilvalue.tag & TAG_TYPE_MASK_ == 0) {
...
pub unsafe extern "C" fn luae_warnerror(state: *mut State, where_0: *const i8) { unsafe {
    let errobj: *mut TValue = &mut (*(*state).top.p.offset(-(1 as isize))).val;
    let msg: *const i8 = if (*errobj).tag & TAG_TYPE_MASK_ == 4 {
...
pub unsafe extern "C" fn lua_getlocal(
    ...
    let name;
    if ar.is_null() {
        if !((*(*state).top.p.offset(-(1 as isize))).val.tag             == TAG_TYPE_CLOSURE_L | TAG_COLLECTABLE)
        {
            name = std::ptr::null();
        } else {
            name = luaf_getlocalname(
...
pub unsafe extern "C" fn lua_getinfo(
    ...
    let cl: *mut UClosure = if (*function).tag == TAG_TYPE_CLOSURE_L | TAG_COLLECTABLE
        || (*function).tag == TAG_TYPE_CLOSURE_C | TAG_COLLECTABLE
    {
...
pub unsafe extern "C" fn kname(
    ...
    if (*kvalue).tag & TAG_TYPE_MASK_ == 4 {
...
pub unsafe extern "C" fn luag_concaterror(
    ...
    if (*p1).tag & TAG_TYPE_MASK_ == 4 || (*p1).tag & TAG_TYPE_MASK_ == 3 {
        p1 = p2;
    }
...
pub unsafe extern "C" fn tryagain(
    ...
    let g: *mut Global = (*state).global;
    if (*g).nilvalue.tag & TAG_TYPE_MASK_ == 0 && (*g).gcstopem == 0 {
        luac_fullgc(state, 1);
...
pub unsafe extern "C" fn luat_gettmbyobj(
    ...
    match (*o).tag & TAG_TYPE_MASK_ {
        ...
        _ => {
            mt = (*(*state).global).mt[((*o).tag & TAG_TYPE_MASK_) as usize];
        }
    }
...
pub unsafe extern "C" fn luat_objtypename(
    ...
    if (*o).tag == TAG_TYPE_TABLE | TAG_COLLECTABLE && {
        mt = (*((*o).value.gc as *mut GCUnion)).h.metatable;
        !mt.is_null()
    } || (*o).tag == TAG_TYPE_USER | TAG_COLLECTABLE && {
        mt = (*((*o).value.gc as *mut GCUnion)).u.metatable;
        !mt.is_null()
    } {
        let name: *const TValue =
            luah_getshortstr(mt, luas_new(state, b"__name\0" as *const u8 as *const i8));
        if (*name).tag & TAG_TYPE_MASK_ == 4 {
            return ((*((*name).value.gc as *mut GCUnion)).ts.contents).as_mut_ptr();
        }
    }
    return TYPE_NAMES[(((*o).tag & TAG_TYPE_MASK_) + 1) as usize];
}}
...
pub unsafe extern "C" fn luat_trybintm(
    ...
    if ((callbintm(state, p1, p2, res, event) == 0) as i32 != 0) as i32 as i64 != 0 {
        match event as u32 {
            13 | 14 | 15 | 16 | 17 | 19 => {
                if (*p1).tag & TAG_TYPE_MASK_ == 3 && (*p2).tag & TAG_TYPE_MASK_ == 3 {
...
pub unsafe extern "C" fn luat_callordertm(
    ...
    if callbintm(state, p1, p2, (*state).top.p, event) != 0 {
        return !((*(*state).top.p).val.tag == TAG_TYPE_BOOLEAN_FALSE
            || (*(*state).top.p).val.tag & TAG_TYPE_MASK_ == 0) as i32;
    }
...
pub unsafe extern "C" fn clearkey(n: *mut Node) { unsafe {
    if (*n).u.key_tag & TAG_COLLECTABLE != 0 {
...
pub unsafe extern "C" fn iscleared(g: *mut Global, o: *const Object) -> i32 { unsafe {
    if o.is_null() {
        return 0;
    } else if (*o).tag & TAG_TYPE_MASK_ == 4 {
...
pub unsafe extern "C" fn luac_newobjdt(
    ...
    let g: *mut Global = (*state).global;
    let p: *mut i8 = luam_malloc_(state, size, (tag & TAG_TYPE_MASK_) as i32) as *mut i8;
...
pub unsafe extern "C" fn reallymarkobject(g: *mut Global, o: *mut Object) { unsafe {
    ...
    match (*o).tag {
        ...
        9 => {
            ...
            if (*(*uv).v.p).tag & TAG_COLLECTABLE != 0
...
pub unsafe extern "C" fn restartcollection(g: *mut Global) { unsafe {
    ...
    if (*g).l_registry.tag & TAG_COLLECTABLE != 0
...
pub unsafe extern "C" fn traverseweakvalue(g: *mut Global, h: *mut Table) { unsafe {
    ...
    while n < limit {
        if (*n).i_value.tag & TAG_TYPE_MASK_ == 0 {
            clearkey(n);
        } else {
            if (*n).u.key_tag & TAG_COLLECTABLE != 0
            ...
            if hasclears == 0
                && iscleared(
                    g,
                    if (*n).i_value.tag & TAG_COLLECTABLE != 0 {
                        (*n).i_value.value.gc
                    } else {
                        std::ptr::null_mut()
                    },
...
pub unsafe extern "C" fn traverseephemeron(
    ...
    let mut i: u32 = 0;
    while i < asize {
        if (*((*h).array).offset(i as isize)).tag & TAG_COLLECTABLE != 0
    ...
    while i < new_size {
        ...
        } else if (*n).i_value.tag & TAG_COLLECTABLE != 0
            && (*(*n).i_value.value.gc).marked as i32 & (1 << 3 | 1 << 4) != 0
        {
            marked = 1;
...
pub unsafe extern "C" fn traversetable(g: *mut Global, h: *mut Table) -> u64 { unsafe {
    ...
    if !mode.is_null() && (*mode).tag == TAG_TYPE_STRING_SHORT | TAG_COLLECTABLE && {
...
pub unsafe extern "C" fn traverseudata(g: *mut Global, u: *mut Udata) -> i32 { unsafe {
    ...
    while i < (*u).nuvalue as i32 {
        if (*((*u).uv).as_mut_ptr().offset(i as isize)).uv.tag & TAG_COLLECTABLE != 0
...
pub unsafe extern "C" fn traverseproto(g: *mut Global, f: *mut Prototype) -> i32 { unsafe {
    ...
    i = 0;
    while i < (*f).size_k {
        if (*((*f).k).offset(i as isize)).tag & TAG_COLLECTABLE != 0
...
pub unsafe extern "C" fn traversecclosure(g: *mut Global, cl: *mut CClosure) -> i32 { unsafe {
    ...
    while i < (*cl).count_upvalues as i32 {
        if (*((*cl).upvalue).as_mut_ptr().offset(i as isize)).tag & TAG_COLLECTABLE != 0
...
pub unsafe extern "C" fn traversethread(g: *mut Global, th: *mut State) -> i32 { unsafe {
    ...
    while o < (*th).top.p {
        if (*o).val.tag & TAG_COLLECTABLE != 0
...
pub unsafe extern "C" fn gctm_function(state: *mut State) { unsafe {
    ...
    (*io).value.gc = i_g;
    (*io).tag = ((*i_g).tag | TAG_COLLECTABLE) as u8;
    ...
    loop {
        ...
        if (*curr).marked as i32 & (1 << 3 | 1 << 4) != 0 {
            *p = (*curr).next;
            ...
            } else if (*curr).tag == TAG_TYPE_UPVALUE
...
pub unsafe extern "C" fn luaf_newtbcupval(state: *mut State, level: StkId) { unsafe {
    if (*level).val.tag == TAG_TYPE_BOOLEAN_FALSE
        || (*level).val.tag & TAG_TYPE_MASK_ == 0
    {
        return;
    }
    ...
    while i < n {
        ...
        match t {
            ...
            4 | 20 => {
                ...
                (*io_1).tag = ((*x_).tag | TAG_COLLECTABLE) as u8;
            }
            _ => {}
        }
        i += 1;
...
pub unsafe extern "C" fn luau_undump(
    ...
    (*io).value.gc = &mut (*(x_ as *mut GCUnion)).gc;
    (*io).tag = (TAG_TYPE_CLOSURE_L | TAG_COLLECTABLE) as u8;
    luad_inctop(state);
...
pub unsafe extern "C" fn str_checkname(ls: *mut LexState) -> *mut TString { unsafe {
    ...
    let ts: *mut TString = (*ls).t.semantic_info.ts;
    luax_next(ls);
    return ts;
}}
...
pub unsafe extern "C" fn body(
    ...
    checknext(ls, ')' as i32);
    statlist(ls);
    (*new_fs.f).last_line_defined = (*ls).line_number;
...
pub unsafe extern "C" fn funcargs(ls: *mut LexState, f: *mut ExpressionDescription) { unsafe {
    ...
    match (*ls).t.token {
        ...
        292 => {
            codestring(&mut args, (*ls).t.semantic_info.ts);
            luax_next(ls);
        }
        _ => {
            luax_syntaxerror(
...
pub unsafe extern "C" fn simpleexp(ls: *mut LexState, v: *mut ExpressionDescription) { unsafe {
    match (*ls).t.token {
        TK_FLT => {
            init_exp(v, VKFLT, 0);
            (*v).u.nval = (*ls).t.semantic_info.r;
        }
        TK_INT => {
            init_exp(v, VKINT, 0);
            (*v).u.ival = (*ls).t.semantic_info.i;
        }
        TK_STRING => {
            codestring(v, (*ls).t.semantic_info.ts);
        }
        TK_NIL => {
            init_exp(v, VNIL, 0);
        }
...
pub unsafe extern "C" fn localfunc(ls: *mut LexState) { unsafe {
    ...
    new_localvar(ls, str_checkname(ls));
    adjustlocalvars(ls, 1);
    body(ls, &mut b, 0, (*ls).line_number);
...
pub unsafe extern "C" fn luay_parser(
    ...
    (*io_0).value.gc = &mut (*(x0 as *mut GCUnion)).gc;
    (*io_0).tag = (TAG_TYPE_TABLE | TAG_COLLECTABLE) as u8;
    luad_inctop(state);
    (*cl).p = luaf_newproto(state);
    funcstate.f = (*cl).p;
    if (*cl).marked as i32 & 1 << 5 != 0
...
pub unsafe extern "C" fn lexerror(ls: *mut LexState, mut msg: *const i8, token: i32) -> ! { unsafe {
    msg = luag_addinfo((*ls).state, msg, (*ls).source, (*ls).line_number);
    if token != 0 {
        luao_pushfstring(
            (*ls).state,
...
pub unsafe extern "C" fn inclinenumber(ls: *mut LexState) { unsafe {
    ...
    (*ls).line_number += 1;
    if (*ls).line_number >= 2147483647 as i32 {
        lexerror(
            ls,
...
pub unsafe extern "C" fn luax_setinput(
    ...
    (*ls).look_ahead.token = TK_EOS as i32;
    (*ls).zio = zio;
...
pub unsafe extern "C" fn llex(ls: *mut LexState, semantic_info: *mut SemanticInfo) -> i32 { unsafe {
    (*(*ls).buffer).length = 0;
    loop {
        ...
        match (*ls).current {
            ...
            91 => {
                ...
                if sep_0 >= 2 as u64 {
                    read_long_string(ls, semantic_info, sep_0);
            ...
            34 | 39 => {
                read_string(ls, (*ls).current, semantic_info);
                return TK_STRING as i32;
            }
            46 => {
                save(ls, (*ls).current);
                ...
                } else if CHARACTER_TYPE[((*ls).current + 1) as usize] as i32 & 1 << 1 == 0
                {
                    ...
                    return read_numeral(ls, semantic_info);
                }
            }
...
pub unsafe extern "C" fn luax_next(ls: *mut LexState) { unsafe {
    ...
    if (*ls).look_ahead.token != TK_EOS as i32 {
        (*ls).t = (*ls).look_ahead;
        (*ls).look_ahead.token = TK_EOS as i32;
    } else {
        (*ls).t.token = llex(ls, &mut (*ls).t.semantic_info);
    };
}}
pub unsafe extern "C" fn luax_lookahead(ls: *mut LexState) -> i32 { unsafe {
    (*ls).look_ahead.token = llex(ls, &mut (*ls).look_ahead.semantic_info);
    return (*ls).look_ahead.token;
}}
...
pub unsafe extern "C" fn equalkey(
    ...
    if (*k1).tag != (*n2).u.key_tag
        && !(deadok != 0
            && (*n2).u.key_tag == 9 + 2
            && (*k1).tag & TAG_COLLECTABLE != 0)
    {
        return 0;
    }
...
pub unsafe extern "C" fn luah_next(
    ...
    while i < asize {
        if !((*((*t).array).offset(i as isize)).tag & TAG_TYPE_MASK_ == 0) {
    ...
    while (i as i32) < 1 << (*t).log_size_node as i32 {
        if !((*((*t).node).offset(i as isize)).i_value.tag & TAG_TYPE_MASK_ == 0) {
...
pub unsafe extern "C" fn numusearray(t: *const Table, nums: *mut u32) -> u32 { unsafe {
            ...
            .wrapping_sub(1 as u64) as i32
    {
        ...
        while i <= lim {
            if !((*((*t).array).offset(i.wrapping_sub(1 as u32) as isize)).tag                 & TAG_TYPE_MASK_
                == 0)
            {
...
pub unsafe extern "C" fn reinsert(state: *mut State, ot: *mut Table, t: *mut Table) { unsafe {
    ...
    while j < size {
        ...
        if !((*old).i_value.tag & TAG_TYPE_MASK_ == 0) {
            let mut k: TValue = TValue {
                value: Value {
                    gc: std::ptr::null_mut(),
                },
...
pub unsafe extern "C" fn luah_newkey(
    ...
    if (((*key).tag & TAG_TYPE_MASK_ == 0) as i32 != 0) as i32 as i64 != 0 {
    ...
    if (*value).tag & TAG_TYPE_MASK_ == TAG_TYPE_NIL {
        return;
    }
    mp = mainpositiontv(t, key);
    if !((*mp).i_value.tag & TAG_TYPE_MASK_ == 0) || ((*t).last_free).is_null() {
...
pub unsafe extern "C" fn luah_getshortstr(
    ...
    let mut n: *mut Node = &mut *((*t).node)
        ...
        as *mut Node;
    loop {
        if (*n).u.key_tag == TAG_TYPE_STRING_SHORT | TAG_COLLECTABLE
...
pub unsafe extern "C" fn hash_search(t: *mut Table, mut j: u64) -> u64 { unsafe {
    ...
    loop {
        ...
        if j <= (9223372036854775807 as i64 as u64).wrapping_div(2 as u64) {
            ...
            if (*luah_getint(t, j as i64)).tag & TAG_TYPE_MASK_ == 0 {
                break;
            }
        } else {
    ...
    while j.wrapping_sub(i) > 1 as u32 as u64 {
        ...
        if (*luah_getint(t, m as i64)).tag & TAG_TYPE_MASK_ == 0 {
            j = m;
        } else {
            i = m;
        }
...
pub unsafe extern "C" fn binsearch(array: *const TValue, mut i: u32, mut j: u32) -> u32 { unsafe {
    while j.wrapping_sub(i) > 1 as u32 {
        ...
        if (*array.offset(m.wrapping_sub(1 as u32) as isize)).tag & TAG_TYPE_MASK_ == 0 {
            j = m;
        } else {
            i = m;
        }
...
pub unsafe extern "C" fn luah_getn(t: *mut Table) -> u64 { unsafe {
    ...
    if limit > 0u32
        && (*((*t).array).offset(limit.wrapping_sub(1 as u32) as isize)).tag & TAG_TYPE_MASK_
            == 0
    {
        if limit >= 2 as u32
            && !((*((*t).array).offset(limit.wrapping_sub(2 as u32) as isize)).tag                 & TAG_TYPE_MASK_
                == 0)
        {
    ...
    if !((*t).flags as i32 & 1 << 7 == 0
        || (*t).array_limit & ((*t).array_limit).wrapping_sub(1 as u32) == 0u32)
    {
        if (*((*t).array).offset(limit as isize)).tag & TAG_TYPE_MASK_ == 0 {
            return limit as u64;
        }
        limit = luah_realasize(t);
        if (*((*t).array).offset(limit.wrapping_sub(1 as u32) as isize)).tag & TAG_TYPE_MASK_
            == 0
        {
    ...
    if ((*t).last_free).is_null()
        || (*luah_getint(t, limit.wrapping_add(1 as u32) as i64)).tag & TAG_TYPE_MASK_ == 0
    {
        return limit as u64;
    } else {
...
pub unsafe extern "C" fn luak_code(fs: *mut FunctionState, i: u32) -> i32 { unsafe {
    ...
    *((*f).code).offset(fresh134 as isize) = i;
    savelineinfo(fs, f, (*(*fs).ls).last_line);
...
pub unsafe extern "C" fn is_k_string(
    ...
    return ((*e).k as u32 == VK as i32 as u32
        && !((*e).t != (*e).f)
        && (*e).u.info <= (1 << 8) - 1
        && (*((*(*fs).f).k).offset((*e).u.info as isize)).tag             == TAG_TYPE_STRING_SHORT | TAG_COLLECTABLE) as i32;
}}
...
pub unsafe extern "C" fn lessthanothers(
    ...
    if (*l).tag & TAG_TYPE_MASK_ == 4 && (*r).tag & TAG_TYPE_MASK_ == 4 {
        return (l_strcmp(
...
pub unsafe extern "C" fn luav_lessthan(
    ...
    if (*l).tag & TAG_TYPE_MASK_ == 3 && (*r).tag & TAG_TYPE_MASK_ == 3 {
        return ltnum(l, r);
    } else {
...
pub unsafe extern "C" fn luav_equalobj(
    ...
    if (*t1).tag & 0x3f != (*t2).tag & 0x3f {
        if (*t1).tag & TAG_TYPE_MASK_ != (*t2).tag & TAG_TYPE_MASK_
            || (*t1).tag & TAG_TYPE_MASK_ != 3
        {
            return 0;
        } else {
            let mut i1: i64 = 0;
...
pub unsafe extern "C" fn luav_concat(state: *mut State, mut total: i32) { unsafe {
    ...
    loop {
        let top: StkId = (*state).top.p;
        let mut n: i32 = 2;
        if !((*top.offset(-(2 as isize))).val.tag & TAG_TYPE_MASK_ == 4
            || (*top.offset(-(2 as isize))).val.tag & TAG_TYPE_MASK_ == 3)
            || !((*top.offset(-(1 as isize))).val.tag & TAG_TYPE_MASK_ == 4
                || (*top.offset(-(1 as isize))).val.tag & TAG_TYPE_MASK_ == 3 && {
                    luao_tostring(state, &mut (*top.offset(-(1 as isize))).val);
                    1 != 0
                })
        {
            luat_tryconcattm(state);
        } else if (*top.offset(-(1 as isize))).val.tag             == TAG_TYPE_STRING_SHORT | TAG_COLLECTABLE
            && (*((*top.offset(-(1 as isize))).val.value.gc as *mut GCUnion))
                .ts
                .short_length as i32
                == 0
        {
            ((*top.offset(-(2 as isize))).val.tag & TAG_TYPE_MASK_ == 4
                || (*top.offset(-(2 as isize))).val.tag & TAG_TYPE_MASK_ == 3 && {
                    luao_tostring(state, &mut (*top.offset(-(2 as isize))).val);
                    1 != 0
                }) as i32;
        } else if (*top.offset(-(2 as isize))).val.tag             == TAG_TYPE_STRING_SHORT | TAG_COLLECTABLE
    ...
    match op as u32 {
        ...
        58 | 59 | 62 | 63 | 64 | 65 | 57 => {
            let res: i32 = !((*(*state).top.p.offset(-(1 as isize))).val.tag                 == TAG_TYPE_BOOLEAN_FALSE
                || (*(*state).top.p.offset(-(1 as isize))).val.tag & TAG_TYPE_MASK_ == 0)
                as i32;
            (*state).top.p = (*state).top.p.offset(-1);
            (*state).top.p;
            ...
            loop {
                ...
                match (i >> 0 & !(!(0u32) << 7) << 0) as u32 as u32 {
                    ...
                    10 => {
                        ...
                        (*io1_3).tag = (*io2_3).tag;
                        if (*ra_9).val.tag & TAG_COLLECTABLE != 0 {
                            if (*uv).marked as i32 & 1 << 5 != 0
                    ...
                    11 => {
                        ...
                        if if !((*count_upvalues).tag == TAG_TYPE_TABLE | TAG_COLLECTABLE)
                        {
                            slot = std::ptr::null();
                            0
                        } else {
                    ...
                    12 => {
                        ...
                        if if (*rc_0).tag == TAG_TYPE_NUMERIC_INTEGER {
                            ...
                            if !((*rb_1).tag == TAG_TYPE_TABLE | TAG_COLLECTABLE) {
                                slot_0 = std::ptr::null();
                                0
                            } else {
                                ...
                                !((*slot_0).tag & TAG_TYPE_MASK_ == 0) as i32
                            }
                        } else if !((*rb_1).tag == TAG_TYPE_TABLE | TAG_COLLECTABLE) {
                            slot_0 = std::ptr::null();
                            0
                        } else {
                    ...
                    13 => {
                        ...
                        let c: i32 = (i >> 0 + 7 + 8 + 1 + 8
                            & !(!(0u32) << 8) << 0)
                            as i32;
                        if if !((*rb_2).tag == TAG_TYPE_TABLE | TAG_COLLECTABLE) {
                            slot_1 = std::ptr::null();
                            0
                        } else {
                            ...
                            !((*slot_1).tag & TAG_TYPE_MASK_ == 0) as i32
                        } != 0
                        {
                    ...
                    14 => {
                        ...
                        if if !((*rb_3).tag == TAG_TYPE_TABLE | TAG_COLLECTABLE) {
                            slot_2 = std::ptr::null();
                            0
                        } else {
                            ...
                            !((*slot_2).tag & TAG_TYPE_MASK_ == 0) as i32
                        } != 0
                        {
                    ...
                    15 => {
                        ...
                        if if !((*upval_0).tag == TAG_TYPE_TABLE | TAG_COLLECTABLE) {
                            slot_3 = std::ptr::null();
                            0
                        } else {
                            ...
                            !((*slot_3).tag & TAG_TYPE_MASK_ == 0) as i32
                        } != 0
                        {
                    ...
                    16 => {
                        ...
                        if if (*rb_5).tag == TAG_TYPE_NUMERIC_INTEGER {
                            ...
                            if !((*ra_14).val.tag == TAG_TYPE_TABLE | TAG_COLLECTABLE)
                            {
                                slot_4 = std::ptr::null();
                                0
                            } else {
                                ...
                                !((*slot_4).tag & TAG_TYPE_MASK_ == 0) as i32
                            }
                        } else if !((*ra_14).val.tag == TAG_TYPE_TABLE | TAG_COLLECTABLE)
                        {
                            slot_4 = std::ptr::null();
                            0
                        } else {
                    ...
                    17 => {
                        ...
                        if if !((*ra_15).val.tag == TAG_TYPE_TABLE | TAG_COLLECTABLE) {
                            slot_5 = std::ptr::null();
                            0
                        } else {
                            ...
                            !((*slot_5).tag & TAG_TYPE_MASK_ == 0) as i32
                        } != 0
                        {
                    ...
                    18 => {
                        ...
                        if if !((*ra_16).val.tag == TAG_TYPE_TABLE | TAG_COLLECTABLE) {
                            slot_6 = std::ptr::null();
                            0
                        } else {
                            ...
                            !((*slot_6).tag & TAG_TYPE_MASK_ == 0) as i32
                        } != 0
                        {
                    ...
                    19 => {
                        ...
                        (*io_3).tag = (TAG_TYPE_TABLE | TAG_COLLECTABLE) as u8;
                        if b_3 != 0 || c_1 != 0 {
                    ...
                    20 => {
                        ...
                        if if !((*rb_7).tag == TAG_TYPE_TABLE | TAG_COLLECTABLE) {
                            slot_7 = std::ptr::null();
                            0
                        } else {
                            slot_7 =
                                luah_getstr(&mut (*((*rb_7).value.gc as *mut GCUnion)).h, key_5);
                            !((*slot_7).tag & TAG_TYPE_MASK_ == 0) as i32
                        } != 0
                        {
                    ...
                    58 => {
                        ...
                        } else if (*ra_55).val.tag & TAG_TYPE_MASK_ == 3
                            && (*rb_15).tag & TAG_TYPE_MASK_ == 3
                        {
                    ...
                    OP_LE => {
                        ...
                        } else if (*ra_56).val.tag & TAG_TYPE_MASK_ == 3
                            && (*rb_16).tag & TAG_TYPE_MASK_ == 3
                        {
                    ...
                    66 => {
                        ...
                        let cond_9: i32 = !((*ra_63).val.tag == TAG_TYPE_BOOLEAN_FALSE
                            || (*ra_63).val.tag & TAG_TYPE_MASK_ == 0)
                            as i32;
                ...
                if !((*ra_75.offset(4 as isize)).val.tag & TAG_TYPE_MASK_ == 0) {
