...
pub type ReadFunction =
    Option<unsafe fn(*mut Interpreter, *mut libc::c_void, *mut usize) -> *const i8>;
...
pub type WriteFunction = Option<
    unsafe fn(*mut Interpreter, *const libc::c_void, usize, *mut libc::c_void) -> i32,
>;
pub type ProtectedFunction =
    Option<unsafe fn(*mut Interpreter, *mut libc::c_void) -> ()>;
