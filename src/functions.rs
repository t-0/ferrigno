...
pub type ReadFunction =
    Option<unsafe extern "C" fn(*mut Interpreter, *mut libc::c_void, *mut u64) -> *const i8>;
...
pub type WriteFunction =
    Option<unsafe extern "C" fn(*mut Interpreter, *const libc::c_void, u64, *mut libc::c_void) -> i32>;
