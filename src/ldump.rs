...
pub struct CallInfo {
    ...
    pub u: LDumpC2RustUnnamed_1,
    pub u2: LDumpC2RustUnnamed,
    pub nresults: libc::c_short,
    pub callstatus: libc::c_ushort,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LDumpC2RustUnnamed {
    pub funcidx: i32,
    pub nyield: i32,
    pub nres: i32,
    pub transferinfo: LDumpC2RustUnnamed_0,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LDumpC2RustUnnamed_0 {
    pub ftransfer: libc::c_ushort,
    pub ntransfer: libc::c_ushort,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LDumpC2RustUnnamed_1 {
    pub l: LDumpC2RustUnnamed_3,
    pub c: LDumpC2RustUnnamed_2,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LDumpC2RustUnnamed_2 {
    pub k: lua_KFunction,
    pub old_errfunc: i64,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LDumpC2RustUnnamed_3 {
...
pub union StackValue {
    pub val: TValue,
    pub tbclist: LDumpC2RustUnnamed_4,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LDumpC2RustUnnamed_4 {
    pub value_: Value,
    pub tt_: u8,
...
pub struct UpVal {
    ...
    pub tt: u8,
    pub marked: u8,
    pub v: LDumpC2RustUnnamed_7,
    pub u: LDumpC2RustUnnamed_5,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LDumpC2RustUnnamed_5 {
    pub open: LDumpC2RustUnnamed_6,
    pub value: TValue,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LDumpC2RustUnnamed_6 {
    pub next: *mut UpVal,
    pub previous: *mut *mut UpVal,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LDumpC2RustUnnamed_7 {
    pub p: *mut TValue,
    pub offset: i64,
}
#[derive(Copy, Clone)]
...
pub struct TString {
    ...
    pub shrlen: u8,
    pub hash: u32,
    pub u: LDumpC2RustUnnamed_8,
    pub contents: [libc::c_char; 1],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LDumpC2RustUnnamed_8 {
    pub lnglen: u64,
