...
unsafe extern "C" {
    ...
    fn lua_absindex(L: *mut lua_State, index: libc::c_int) -> libc::c_int;
    ...
    fn lua_len(L: *mut lua_State, index: libc::c_int);
    fn lua_getallocf(L: *mut lua_State, ud: *mut *mut libc::c_void) -> lua_Alloc;
    fn lua_toclose(L: *mut lua_State, index: libc::c_int);
    fn lua_closeslot(L: *mut lua_State, index: libc::c_int);
    fn lua_getstack(
        L: *mut lua_State,
        level: libc::c_int,
        ar: *mut lua_Debug,
...
pub unsafe extern "C" fn luaL_ref(
    ...
    t = lua_absindex(L, t);
    if lua_rawgeti(L, t, (2 as libc::c_int + 1 as libc::c_int) as Integer)
        == 0 as libc::c_int
    {
        ref_0 = 0 as libc::c_int;
        lua_pushinteger(L, 0 as libc::c_int as Integer);
        lua_rawseti(L, t, (2 as libc::c_int + 1 as libc::c_int) as Integer);
    } else {
...
pub unsafe extern "C" fn luaL_unref(
    ...
    if ref_0 >= 0 as libc::c_int {
        t = lua_absindex(L, t);
        lua_rawgeti(L, t, (2 as libc::c_int + 1 as libc::c_int) as Integer);
        lua_rawseti(L, t, ref_0 as Integer);
            ...
            3 => {
                if lua_isinteger(L, index) != 0 {
                    lua_pushfstring(
                        ...
                        lua_tointegerx(L, index, 0 as *mut libc::c_int),
                    );
                } else {
                    lua_pushfstring(
                        L,
                        b"%f\0" as *const u8 as *const libc::c_char,
                        lua_tonumberx(L, index, 0 as *mut libc::c_int),
                    );
                }
            }
            4 => {
...
pub unsafe extern "C" fn luaL_getsubtable(
    ...
    if lua_getfield(L, index, fname) == 5 as libc::c_int {
        return 1 as libc::c_int
    } else {
        lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
        index = lua_absindex(L, index);
