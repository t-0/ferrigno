...
impl Character {
    ...
    pub fn from2(input: i32) -> Option<Character> {
        match input {
            | 00 => Some(Character::Null),
            | 01 => Some(Character::StartOfHeader),
            | 02 => Some(Character::StartOfText),
            | 03 => Some(Character::EndOfText),
            | 04 => Some(Character::EndOfTransmission),
            | 05 => Some(Character::Enquiry),
            | 06 => Some(Character::Acknowledge),
            | 07 => Some(Character::Bell),
            | 08 => Some(Character::Backspace),
            | 09 => Some(Character::HorizontalTab),
            | 10 => Some(Character::LineFeed),
            | 11 => Some(Character::VerticalTab),
            | 12 => Some(Character::FormFeed),
            | 13 => Some(Character::CarriageReturn),
            | 14 => Some(Character::ShiftOut),
            | 15 => Some(Character::ShiftIn),
            | 16 => Some(Character::DataLinkEscape),
            | 17 => Some(Character::DeviceControl1),
            | 18 => Some(Character::DeviceControl2),
            | 19 => Some(Character::DeviceControl3),
            | 20 => Some(Character::DeviceControl4),
            | 21 => Some(Character::NegativeAcknowledge),
            | 22 => Some(Character::Synchronize),
            | 23 => Some(Character::EndOfTransmissionBlock),
            | 24 => Some(Character::Cancel),
            | 25 => Some(Character::EndOfMedium),
            | 26 => Some(Character::Substitute),
            | 27 => Some(Character::Escape),
            | 28 => Some(Character::FileSeparator),
            | 29 => Some(Character::GroupSeparator),
            | 30 => Some(Character::RecordSeparator),
            | 31 => Some(Character::UnitSeparator),
            | 32 => Some(Character::Space),
            | 33 => Some(Character::Exclamation),
            | 34 => Some(Character::DoubleQuote),
            | 35 => Some(Character::Octothorpe),
            | 36 => Some(Character::Dollar),
            | 37 => Some(Character::Percent),
            | 38 => Some(Character::Ampersand),
            | 39 => Some(Character::Quote),
            | 40 => Some(Character::ParenthesisLeft),
            | 41 => Some(Character::ParenthesisRight),
            | 42 => Some(Character::Asterisk),
            | 43 => Some(Character::Plus),
            | 44 => Some(Character::Comma),
            | 45 => Some(Character::Hyphen),
            | 46 => Some(Character::Period),
            | 47 => Some(Character::Solidus),
            | 48 => Some(Character::Digit0),
            | 49 => Some(Character::Digit1),
            | 50 => Some(Character::Digit2),
            | 51 => Some(Character::Digit3),
            | 52 => Some(Character::Digit4),
            | 53 => Some(Character::Digit5),
            | 54 => Some(Character::Digit6),
            | 55 => Some(Character::Digit7),
            | 56 => Some(Character::Digit8),
            | 57 => Some(Character::Digit9),
            | 58 => Some(Character::Colon),
            | 59 => Some(Character::Semicolon),
            | 60 => Some(Character::AngleLeft),
            | 61 => Some(Character::Equal),
            | 62 => Some(Character::AngleRight),
            | 63 => Some(Character::Question),
            | 64 => Some(Character::At),
            | 65 => Some(Character::UpperA),
            | 66 => Some(Character::UpperB),
            | 67 => Some(Character::UpperC),
            | 68 => Some(Character::UpperD),
            | 69 => Some(Character::UpperE),
            | 70 => Some(Character::UpperF),
            | 71 => Some(Character::UpperG),
            | 72 => Some(Character::UpperH),
            | 73 => Some(Character::UpperI),
            | 74 => Some(Character::UpperJ),
            | 75 => Some(Character::UpperK),
            | 76 => Some(Character::UpperL),
            | 77 => Some(Character::UpperM),
            | 78 => Some(Character::UpperN),
            | 79 => Some(Character::UpperO),
            | 80 => Some(Character::UpperP),
            | 81 => Some(Character::UpperQ),
            | 82 => Some(Character::UpperR),
            | 83 => Some(Character::UpperS),
            | 84 => Some(Character::UpperT),
            | 85 => Some(Character::UpperU),
            | 86 => Some(Character::UpperV),
            | 87 => Some(Character::UpperW),
            | 88 => Some(Character::UpperX),
            | 89 => Some(Character::UpperY),
            | 90 => Some(Character::UpperZ),
            | 91 => Some(Character::BracketLeft),
            | 92 => Some(Character::Backslash),
            | 93 => Some(Character::BracketRight),
            | 94 => Some(Character::Caret),
            | 95 => Some(Character::Underscore),
            | 96 => Some(Character::Grave),
            | 97 => Some(Character::LowerA),
            | 98 => Some(Character::LowerB),
            | 99 => Some(Character::LowerC),
            | 100 => Some(Character::LowerD),
            | 101 => Some(Character::LowerE),
            | 102 => Some(Character::LowerF),
            | 103 => Some(Character::LowerG),
            | 104 => Some(Character::LowerH),
            | 105 => Some(Character::LowerI),
            | 106 => Some(Character::LowerJ),
            | 107 => Some(Character::LowerK),
            | 108 => Some(Character::LowerL),
            | 109 => Some(Character::LowerM),
            | 110 => Some(Character::LowerN),
            | 111 => Some(Character::LowerO),
            | 112 => Some(Character::LowerP),
            | 113 => Some(Character::LowerQ),
            | 114 => Some(Character::LowerR),
            | 115 => Some(Character::LowerS),
            | 116 => Some(Character::LowerT),
            | 117 => Some(Character::LowerU),
            | 118 => Some(Character::LowerV),
            | 119 => Some(Character::LowerW),
            | 120 => Some(Character::LowerX),
            | 121 => Some(Character::LowerY),
            | 122 => Some(Character::LowerZ),
            | 123 => Some(Character::BraceLeft),
            | 124 => Some(Character::Bar),
            | 125 => Some(Character::BraceRight),
            | 126 => Some(Character::Tilde),
            | 127 => Some(Character::Delete),
            | -1 => None,
            | _ => Some(Character::Null),
        }
    }
