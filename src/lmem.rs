...
pub struct CallInfo {
    ...
    pub u: LMemC2RustUnnamed_1,
    pub u2: LMemC2RustUnnamed,
    pub nresults: libc::c_short,
    pub callstatus: libc::c_ushort,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LMemC2RustUnnamed {
    pub funcidx: i32,
    pub nyield: i32,
    pub nres: i32,
    pub transferinfo: LMemC2RustUnnamed_0,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LMemC2RustUnnamed_0 {
    pub ftransfer: libc::c_ushort,
    pub ntransfer: libc::c_ushort,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LMemC2RustUnnamed_1 {
    pub l: LMemC2RustUnnamed_3,
    pub c: LMemC2RustUnnamed_2,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LMemC2RustUnnamed_2 {
    pub k: lua_KFunction,
    pub old_errfunc: i64,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LMemC2RustUnnamed_3 {
...
pub union StackValue {
    pub val: TValue,
    pub tbclist: LMemC2RustUnnamed_4,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LMemC2RustUnnamed_4 {
    pub value_: Value,
    pub tt_: u8,
...
pub struct UpVal {
    ...
    pub tt: u8,
    pub marked: u8,
    pub v: LMemC2RustUnnamed_7,
    pub u: LMemC2RustUnnamed_5,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LMemC2RustUnnamed_5 {
    pub open: LMemC2RustUnnamed_6,
    pub value: TValue,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LMemC2RustUnnamed_6 {
    pub next: *mut UpVal,
    pub previous: *mut *mut UpVal,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LMemC2RustUnnamed_7 {
    pub p: *mut TValue,
    pub offset: i64,
}
#[derive(Copy, Clone)]
...
pub struct TString {
    ...
    pub shrlen: u8,
    pub hash: u32,
    pub u: LMemC2RustUnnamed_8,
    pub contents: [libc::c_char; 1],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LMemC2RustUnnamed_8 {
    pub lnglen: u64,
...
pub unsafe extern "C" fn luaM_growaux_(
    ...
    if size >= limit / 2i32 {
        if ((size >= limit) as i32 != 0i32) as i32 as i64 != 0 {
            luaG_runerror(
                L,
    ...
    newblock = luaM_saferealloc_(
        L,
        block,
        (*psize as u64).wrapping_mul(size_elems as libc::c_ulong),
        (size as u64).wrapping_mul(size_elems as libc::c_ulong),
    );
    *psize = size;
    return newblock;
}
...
pub unsafe extern "C" fn luaM_shrinkvector_(
    ...
    let mut newblock: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut oldsize: u64 = (*size * size_elem) as u64;
    let mut newsize: u64 = (final_n * size_elem) as u64;
...
pub unsafe extern "C" fn luaM_realloc_(
    ...
    newblock = (Some(((*g).frealloc).expect("non-null function pointer")))
        .expect("non-null function pointer")((*g).ud, block, osize, nsize);
    if ((newblock.is_null() && nsize > 0i32 as libc::c_ulong) as i32 != 0i32) as i32 as i64 != 0 {
...
pub unsafe extern "C" fn luaM_malloc_(
    ...
    if size == 0i32 as libc::c_ulong {
        ...
        if ((newblock == 0 as *mut libc::c_void) as i32 != 0i32) as i32 as i64 != 0 {
            newblock = tryagain(L, 0 as *mut libc::c_void, tag as u64, size);
            if newblock.is_null() {
                luaD_throw(L, 4i32);
            }
        }
