...
unsafe extern "C" {
    ...
    fn luaD_closeprotected(L: *mut lua_State, level: i64, status: i32) -> i32;
    fn luaD_reallocstack(L: *mut lua_State, newsize: i32, raiseerror: i32) -> i32;
    fn luaD_rawrunprotected(L: *mut lua_State, f: Pfunc, ud: *mut libc::c_void) -> i32;
    fn luaF_closeupval(L: *mut lua_State, level: StkId);
    fn luaC_freeallobjects(L: *mut lua_State);
    fn luaC_step(L: *mut lua_State);
    fn luaC_newobjdt(L: *mut lua_State, tt: i32, sz: u64, offset: u64) -> *mut GCObject;
    fn luaX_init(L: *mut lua_State);
    fn luaS_hash(str: *const libc::c_char, l: u64, seed: u32) -> u32;
...
pub struct CallInfo {
    ...
    pub u: LStateC2RustUnnamed_1,
    pub u2: LStateC2RustUnnamed,
    pub nresults: libc::c_short,
    pub callstatus: libc::c_ushort,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LStateC2RustUnnamed {
    pub funcidx: i32,
    pub nyield: i32,
    pub nres: i32,
    pub transferinfo: LStateC2RustUnnamed_0,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LStateC2RustUnnamed_0 {
    pub ftransfer: libc::c_ushort,
    pub ntransfer: libc::c_ushort,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LStateC2RustUnnamed_1 {
    pub l: LStateC2RustUnnamed_3,
    pub c: LStateC2RustUnnamed_2,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LStateC2RustUnnamed_2 {
    pub k: lua_KFunction,
    pub old_errfunc: i64,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LStateC2RustUnnamed_3 {
...
pub union StackValue {
    pub val: TValue,
    pub tbclist: LStateC2RustUnnamed_4,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LStateC2RustUnnamed_4 {
    pub value_: Value,
    pub tt_: u8,
...
pub struct UpVal {
    ...
    pub tt: u8,
    pub marked: u8,
    pub v: LStateC2RustUnnamed_7,
    pub u: LStateC2RustUnnamed_5,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LStateC2RustUnnamed_5 {
    pub open: LStateC2RustUnnamed_6,
    pub value: TValue,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LStateC2RustUnnamed_6 {
    pub next: *mut UpVal,
    pub previous: *mut *mut UpVal,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LStateC2RustUnnamed_7 {
    pub p: *mut TValue,
    pub offset: i64,
}
#[derive(Copy, Clone)]
...
pub struct TString {
    ...
    pub shrlen: u8,
    pub hash: u32,
    pub u: LStateC2RustUnnamed_8,
    pub contents: [libc::c_char; 1],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LStateC2RustUnnamed_8 {
    pub lnglen: u64,
...
unsafe extern "C" fn luai_makeseed(mut L: *mut lua_State) -> u32 {
    let mut buff: [libc::c_char; 24] = [0; 24];
    let mut h: u32 = time(0 as *mut time_t) as u32;
    let mut p: i32 = 0i32;
    let mut t: u64 = L as u64;
    memcpy(
    ...
    p = (p as libc::c_ulong).wrapping_add(::core::mem::size_of::<u64>() as libc::c_ulong) as i32
        as i32;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn lua_setcstacklimit(mut _L: *mut lua_State, mut _limit: u32) -> i32 {
    return 200i32;
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn luaE_extendCI(mut L: *mut lua_State) -> *mut CallInfo {
    ...
    ci =
        luaM_malloc_(L, ::core::mem::size_of::<CallInfo>() as libc::c_ulong, 0i32) as *mut CallInfo;
    (*(*L).ci).next = ci;
    (*ci).previous = (*L).ci;
...
pub unsafe extern "C" fn luaE_checkcstack(mut L: *mut lua_State) {
    ...
    } else if (*L).nCcalls & 0xffff as i32 as u32 >= (200i32 / 10i32 * 11i32) as u32 {
        luaD_errerr(L);
    }
}
#[unsafe(no_mangle)]
...
unsafe extern "C" fn stack_init(mut L1: *mut lua_State, mut L: *mut lua_State) {
    ...
    while i < 2i32 * 20i32 + 5i32 {
        (*((*L1).stack.p).offset(i as isize)).val.tt_ = (0i32 | (0i32) << 4i32) as u8;
        i += 1;
    }
    (*L1).top.p = (*L1).stack.p;
    (*L1).stack_last.p = ((*L1).stack.p).offset((2i32 * 20i32) as isize);
    ci = &mut (*L1).base_ci;
    ...
    (*(*L1).top.p).val.tt_ = (0i32 | (0i32) << 4i32) as u8;
...
unsafe extern "C" fn freestack(mut L: *mut lua_State) {
    ...
    luaM_free_(
        ...
        ((((*L).stack_last.p).offset_from((*L).stack.p) as i64 as i32 + 5i32) as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<StackValue>() as libc::c_ulong),
    );
}
unsafe extern "C" fn init_registry(mut L: *mut lua_State, mut g: *mut global_State) {
    ...
    luaH_resize(L, registry, 2i32 as u32, 0i32 as u32);
    let mut io_0: *mut TValue =
        &mut *((*registry).array).offset((1i32 - 1i32) as isize) as *mut TValue;
    let mut x__0: *mut lua_State = L;
    (*io_0).value_.gc = &mut (*(x__0 as *mut GCUnion)).gc;
    (*io_0).tt_ = (8i32 | (0i32) << 4i32 | (1i32) << 6i32) as u8;
    let mut io_1: *mut TValue =
        &mut *((*registry).array).offset((2i32 - 1i32) as isize) as *mut TValue;
    let mut x__1: *mut Table = luaH_new(L);
    (*io_1).value_.gc = &mut (*(x__1 as *mut GCUnion)).gc;
    (*io_1).tt_ = (5i32 | (0i32) << 4i32 | (1i32) << 6i32) as u8;
}
unsafe extern "C" fn f_luaopen(mut L: *mut lua_State, mut _ud: *mut libc::c_void) {
    ...
    luaX_init(L);
    (*g).gcstp = 0i32 as u8;
    (*g).nilvalue.tt_ = (0i32 | (0i32) << 4i32) as u8;
}
unsafe extern "C" fn preinit_thread(mut L: *mut lua_State, mut g: *mut global_State) {
    ...
    (*L).twups = L;
    (*L).nCcalls = 0i32 as u32;
    (*L).errorJmp = 0 as *mut LongJump;
    ::core::ptr::write_volatile(&mut (*L).hook as *mut lua_Hook, None);
    ::core::ptr::write_volatile(&mut (*L).hookmask as *mut sig_atomic_t, 0i32);
    (*L).basehookcount = 0i32;
    (*L).allowhook = 1i32 as u8;
    (*L).hookcount = (*L).basehookcount;
    (*L).openupval = 0 as *mut UpVal;
    (*L).status = 0i32 as u8;
    (*L).errfunc = 0i32 as i64;
    (*L).oldpc = 0i32;
}
unsafe extern "C" fn close_state(mut L: *mut lua_State) {
    ...
    if !((*g).nilvalue.tt_ as i32 & 0xf as i32 == 0i32) {
        ...
        (*L).ci = &mut (*L).base_ci;
        (*L).errfunc = 0i32 as i64;
        luaD_closeprotected(L, 1i32 as i64, 0i32);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn luaE_resetthread(mut L: *mut lua_State, mut status: i32) -> i32 {
    (*L).ci = &mut (*L).base_ci;
    let mut ci: *mut CallInfo = (*L).ci;
    (*(*L).stack.p).val.tt_ = (0i32 | (0i32) << 4i32) as u8;
    (*ci).func.p = (*L).stack.p;
    (*ci).callstatus = ((1i32) << 1i32) as libc::c_ushort;
    if status == 1i32 {
        status = 0i32;
    ...
    (*L).status = 0i32 as u8;
    (*L).errfunc = 0i32 as i64;
    status = luaD_closeprotected(L, 1i32 as i64, status);
    if status != 0i32 {
    ...
    luaD_reallocstack(
        L,
        ((*ci).top.p).offset_from((*L).stack.p) as i64 as i32,
        0i32,
    );
    return status;
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn lua_closethread(mut L: *mut lua_State, mut from: *mut lua_State) -> i32 {
...
pub unsafe extern "C" fn lua_newstate(
    ...
    (*L).marked = ((*g).currentwhite as i32 & ((1i32) << 3i32 | (1i32) << 4i32)) as u8;
    preinit_thread(L, g);
    ...
    (*g).l_registry.tt_ = (0i32 | (0i32) << 4i32) as u8;
    (*g).panic = None;
...
pub unsafe extern "C" fn luaE_warnerror(mut L: *mut lua_State, mut where_0: *const libc::c_char) {
    let mut errobj: *mut TValue = &mut (*((*L).top.p).offset(-(1i32 as isize))).val;
    let mut msg: *const libc::c_char = if (*errobj).tt_ as i32 & 0xf as i32 == 4i32 {
    ...
    luaE_warning(L, b"error in \0" as *const u8 as *const libc::c_char, 1i32);
