...
pub unsafe fn setvararg(state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, nparams: i32) {
    unsafe {
        ...
        code_abck(state, lexical_state, function_state, OPCODE_VARARGPREP, nparams, 0, 0, 0);
    }
}
pub unsafe fn errorlimit(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, limit: i32, what: *const i8,
) -> ! {
    unsafe {
...
pub unsafe fn checklimit(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, v: i32, length: i32, what: *const i8,
) {
    unsafe {
        if v > length {
...
pub unsafe fn allocate_upvalue_description(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, prototype: *mut Prototype,
...
pub unsafe fn newupvalue(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, name: *mut TString,
    v: *mut ExpressionDescription,
) -> i32 {
    unsafe {
        let upvalue_description: *mut UpValueDescription =
        ...
        while i >= 0 {
            ...
            if kind >= GDKREG {
                        ...
                        .variabledescriptioncontent_name
                {
                    ...
                    ExpressionDescription::init_exp(var, ExpressionKind::Global, (*function_state).functionstate_first_local + i);
...
pub unsafe fn singlevaraux(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, n: *mut TString,
            ...
            if v >= 0 {
                ...
                if index < 0 {
                    if !(*function_state).functionstate_previous.is_null() {
                        singlevaraux(state, lexical_state, (*function_state).functionstate_previous, n, var, 0);
                    }
                    if (*var).expressiondescription_expressionkind == ExpressionKind::Local
...
pub unsafe fn fixforjump(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, program_counter: i32, dest: i32,
    back: i32,
) {
    unsafe {
...
pub unsafe fn previousinstruction(function_state: *mut FunctionState) -> *mut u32 {
    unsafe {
        ...
        if (*function_state).functionstate_program_counter > (*function_state).functionstate_last_target {
            &mut *((*(*function_state).functionstate_prototype).prototype_code.vectort_pointer)
...
pub unsafe fn code_constant_nil(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, mut from: i32, n: i32,
) {
    unsafe {
        ...
        code_abck(state, lexical_state, function_state, OPCODE_LOADNIL, from, n - 1, 0, 0);
    }
}
pub unsafe fn code_get_jump(function_state: *mut FunctionState, program_counter: i32) -> i32 {
    unsafe {
        let offset: i32 = (*((*(*function_state).functionstate_prototype).prototype_code.vectort_pointer)
            ...
            & MASK_AX) as i32
            - OFFSET_SJ;
        if offset == -1 { -1 } else { program_counter + 1 + offset }
    }
}
...
pub unsafe fn luak_concat(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, l1: *mut i32, l2: i32,
) {
    unsafe {
        if l2 == -1 {
        } else if *l1 == -1 {
...
pub unsafe fn luak_ret(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, first: i32, nret: i32,
) {
    unsafe {
        let op: u32;
        match nret {
        ...
        checklimit(state, lexical_state, function_state, nret + 1, MAXARG_B, c"returns".as_ptr());
        code_abck(state, lexical_state, function_state, op, first, nret + 1, 0, 0);
    }
}
pub unsafe fn condjump(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, op: u32, a: i32, b: i32, c: i32,
    k: i32,
) -> i32 {
    unsafe {
...
pub unsafe fn patchlistaux(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, mut list: i32, vtarget: i32, reg: i32,
    dtarget: i32,
) {
    unsafe {
        while list != -1 {
...
pub unsafe fn luak_patchlist(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, list: i32, target: i32,
) {
    unsafe {
        patchlistaux(state, lexical_state, function_state, list, target, NO_REG, target);
    }
}
...
pub unsafe fn savelineinfo(
    state: *mut State, _lexical_state: *mut LexicalState, function_state: *mut FunctionState, prototype: *mut Prototype, line: i32,
) {
    unsafe {
...
pub unsafe fn code_abck(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, o: u32, a: i32, b: i32, c: i32, k: i32,
) -> i32 {
    unsafe {
        luak_code(
            state,
...
pub unsafe fn luak_codeabx(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, o: u32, a: i32, bc: u32,
) -> i32 {
    unsafe {
        luak_code(
            state,
...
pub unsafe fn codeasbx(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, o: u32, a: i32, bc: i32,
) -> i32 {
    unsafe {
...
pub unsafe fn codesj(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, o: u32, sj: i32, k: i32,
) -> i32 {
    unsafe {
...
pub unsafe fn codeextraarg(state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, a: i32) -> i32 {
    unsafe { luak_code(state, lexical_state, function_state, OPCODE_EXTRAARG | (a as u32) << POSITION_A) }
}
pub unsafe fn code_constant(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, reg: i32, k: i32,
) -> i32 {
    unsafe {
        if k <= MAXARG_BX {
            luak_codeabx(state, lexical_state, function_state, OPCODE_LOADK, reg, k as u32)
        } else {
...
pub unsafe fn addk(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, key: *mut TValue, v: *mut TValue,
) -> i32 {
    unsafe {
        ...
        {
            Object::luac_barrier_(state, &mut *(prototype as *mut Object), &mut *(*v).as_object().unwrap());
        }
        count_constants
    }
}
pub unsafe fn string_constant(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, s: *mut TString,
) -> i32 {
    unsafe {
...
pub unsafe fn luak_int_k(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, integer: i64,
) -> i32 {
    unsafe {
        let mut tvalue: TValue = TValue::new(TagVariant::NilNil);
        tvalue.set_integer(integer);
        addk(state, lexical_state, function_state, &mut tvalue, &mut tvalue)
    }
}
pub unsafe fn luak_number_k(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, number: f64,
) -> i32 {
    unsafe {
        let mut tvalue: TValue = TValue::new(TagVariant::NilNil);
        let mut ik: i64 = 0;
...
pub unsafe fn code_constant_integer(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, reg: i32, i: i64,
) {
    unsafe {
        if fits_bx(i) {
            codeasbx(state, lexical_state, function_state, OPCODE_LOADI, reg, i as i32);
        } else {
            code_constant(
                state,
                lexical_state,
...
pub unsafe fn code_constant_number(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, reg: i32, number: f64,
) {
    unsafe {
        let mut fi: i64 = 0;
        if F2I::Equal.convert_f64_i64(number, &mut fi) && fits_bx(fi) {
            codeasbx(state, lexical_state, function_state, OPCODE_LOADF, reg, fi as i32);
        } else {
            code_constant(
                state,
                lexical_state,
    ...
    unsafe {
        ...
        match (*expression_description).expressiondescription_expressionkind {
            ...
            | ExpressionKind::False => {
                code_abck(state, lexical_state, function_state, OPCODE_LOAD_FALSE, register, 0, 0, 0);
            },
            | ExpressionKind::True => {
                code_abck(state, lexical_state, function_state, OPCODE_LOAD_TRUE, register, 0, 0, 0);
            },
...
pub unsafe fn code_loadbool(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, a: i32, op: u32,
) -> i32 {
    unsafe {
...
pub unsafe fn exp2reg(
    ...
    unsafe {
        discharge2reg(state, lexical_state, function_state, expression_description, reg);
...
pub unsafe fn luak_exp2anyreg(
    ...
    unsafe {
        ...
        (*expression_description).expressiondescription_value.value_info as i64
    }
}
...
pub unsafe fn codeabrk(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, o: u32, a: i32, b: i32,
...
pub unsafe fn luak_self(
    ...
    unsafe {
        ...
        (*expression_description).expressiondescription_value.value_info = base;
        (*expression_description).expressiondescription_expressionkind = ExpressionKind::Nonrelocatable;
        ...
        if code_expression_to_constant(state, lexical_state, function_state, key) != 0 {
            ...
            code_abck(state, lexical_state, function_state, OPCODE_MOVE, base + 1, ereg, 0, 0);
            code_abck(
                state,
                lexical_state,
                function_state,
...
pub unsafe fn luak_goiftrue(
    ...
    unsafe {
        ...
        match (*expression_description).expressiondescription_expressionkind {
            ...
            | _ => {
                program_counter = jumponcond(state, lexical_state, function_state, expression_description, 0);
            },
        }
        luak_concat(
            state,
...
pub unsafe fn luak_goiffalse(
    ...
    unsafe {
        ...
        match (*expression_description).expressiondescription_expressionkind {
            ...
            | _ => {
                program_counter = jumponcond(state, lexical_state, function_state, expression_description, 1);
            },
        }
        luak_concat(
            state,
...
pub unsafe fn constfolding(
    state: *mut State, _lexical_state: *mut LexicalState, _function_state: *mut FunctionState, op: i32,
...
pub unsafe fn code_unary_expression_value(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, op: u32,
    ...
    unsafe {
        ...
        freeexp(lexical_state, function_state, expression_description);
        (*expression_description).expressiondescription_value.value_info =
            code_abck(state, lexical_state, function_state, op, 0, register as i32, 0, 0);
        (*expression_description).expressiondescription_expressionkind = ExpressionKind::Relocatable;
        luak_fixline(state, lexical_state, function_state, line);
    }
}
pub unsafe fn finishbinexpval(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, e1: *mut ExpressionDescription,
    e2: *mut ExpressionDescription, op: u32, v2: i32, flip: i32, line: i32, mmop: u32, event: u32,
) {
    unsafe {
        let v1 = luak_exp2anyreg(state, lexical_state, function_state, e1);
        let program_counter: i32 = code_abck(state, lexical_state, function_state, op, 0, v1 as i32, v2, 0);
        ...
        luak_fixline(state, lexical_state, function_state, line);
        code_abck(state, lexical_state, function_state, mmop, v1 as i32, v2, event as i32, flip);
        luak_fixline(state, lexical_state, function_state, line);
    }
}
pub unsafe fn codebinexpval(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, binary: OperatorBinary,
...
pub unsafe fn codebini(
    ...
    unsafe {
        ...
        finishbinexpval(
            state, lexical_state, function_state, e1, e2, op, v2, flip, line, OPCODE_MMBINI, event,
        );
    }
}
pub unsafe fn codebink(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, opr: OperatorBinary,
    ...
    unsafe {
        ...
        finishbinexpval(
            state, lexical_state, function_state, e1, e2, op, v2, flip, line, OPCODE_MMBINK, event,
        );
    }
}
pub unsafe fn finishbinexpneg(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, e1: *mut ExpressionDescription,
    e2: *mut ExpressionDescription, op: u32, line: i32, event: u32,
) -> i32 {
    unsafe {
...
pub unsafe fn codearith(
    ...
    unsafe {
        ...
        {
            codebink(state, lexical_state, function_state, opr, e1, e2, flip, line);
        } else {
            codebinnok(state, lexical_state, function_state, opr, e1, e2, flip, line);
        };
    }
}
...
pub unsafe fn codeorder(
    ...
    unsafe {
        ...
        (*e1).expressiondescription_value.value_info = condjump(
            state, lexical_state, function_state, op, r1 as i32, r2 as i32, is_float as i32, 1,
        );
...
pub unsafe fn luak_prefix(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, unary: OperatorUnary,
    expression_description: *mut ExpressionDescription, line: i32,
) {
    unsafe {
...
pub unsafe fn luak_infix(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, op: OperatorBinary,
    v: *mut ExpressionDescription,
) {
    unsafe {
...
pub unsafe fn codeconcat(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, e1: *mut ExpressionDescription,
    e2: *mut ExpressionDescription, line: i32,
) {
    unsafe {
...
pub unsafe fn luak_posfix(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, mut binary: OperatorBinary,
    expression_description_a: *mut ExpressionDescription, expression_description_b: *mut ExpressionDescription, line: i32,
) {
    unsafe {
        luak_dischargevars(state, lexical_state, function_state, expression_description_b);
        if binary as u32 <= OperatorBinary::ShiftRight as u32
            && constfolding(
                state, lexical_state, function_state, binary as i32, expression_description_a, expression_description_b,
            ) != 0
        {
            return;
        }
        match binary {
            ...
            | OperatorBinary::Concatenate => {
                luak_exp2nextreg(state, lexical_state, function_state, expression_description_b);
                codeconcat(
                    state, lexical_state, function_state, expression_description_a, expression_description_b, line,
                );
            },
            | OperatorBinary::Add => {
                let mut flip: i32 = 0;
                ...
                if ExpressionDescription::is_sc_int(expression_description_b) {
                    codebini(
                        state, lexical_state, function_state, OPCODE_ADDI, expression_description_a, expression_description_b,
                        flip, line, TM_ADD,
                    );
                } else {
                    codearith(
                        state, lexical_state, function_state, binary, expression_description_a, expression_description_b, flip,
                        line,
                    );
                };
            },
            | OperatorBinary::Multiply => {
                ...
                codearith(
                    state, lexical_state, function_state, binary, expression_description_a, expression_description_b, flip, line,
                );
            },
            | OperatorBinary::Subtract => {
                if finishbinexpneg(
                    state, lexical_state, function_state, expression_description_a, expression_description_b, OPCODE_ADDI, line,
                    TM_SUB,
                ) == 0
                {
                    codearith(
                        state, lexical_state, function_state, binary, expression_description_a, expression_description_b, 0, line,
                    );
                }
            },
            ...
            | OperatorBinary::BitwiseAnd => {
                codebitwise(
                    state, lexical_state, function_state, binary, expression_description_a, expression_description_b, line,
                );
            },
            ...
            | OperatorBinary::ShiftLeft => {
                if ExpressionDescription::is_sc_int(expression_description_a) {
                    ExpressionDescription::swapexps(expression_description_a, expression_description_b);
                    codebini(
                        state, lexical_state, function_state, OPCODE_SHLI, expression_description_a, expression_description_b, 1,
                        line, TM_SHL,
                    );
                } else if finishbinexpneg(
                    state, lexical_state, function_state, expression_description_a, expression_description_b, OPCODE_SHRI, line,
                    TM_SHL,
                ) == 0
                {
                    codebinexpval(
            ...
            | OperatorBinary::ShiftRight => {
                if ExpressionDescription::is_sc_int(expression_description_b) {
                    codebini(
                        state, lexical_state, function_state, OPCODE_SHRI, expression_description_a, expression_description_b, 0,
                        line, TM_SHR,
                    );
                } else {
                    codebinexpval(
            ...
            | OperatorBinary::Inequal => {
                codeeq(
                    state, lexical_state, function_state, binary, expression_description_a, expression_description_b,
                );
            },
...
pub unsafe fn luak_settablesize(
    _state: *mut State, function_state: *mut FunctionState, program_counter: i32, ra: i32, asize: i32, hsize: i32,
) {
    unsafe {
...
pub unsafe fn luak_setlist(
    state: *mut State, lexical_state: *mut LexicalState, function_state: *mut FunctionState, base: i32, mut count_elements: usize,
    mut tostore: i32,
) {
    unsafe {
        if tostore == -1 {
        ...
        if count_elements <= MAXARG_C as usize {
            code_abck(
                state, lexical_state, function_state, OPCODE_SETLIST, base, tostore, count_elements as i32, 0,
            );
        } else {
            let extra = count_elements / (MAXARG_C as usize + 1);
            count_elements %= MAXARG_C as usize + 1;
            code_abck(
                state, lexical_state, function_state, OPCODE_SETLIST, base, tostore, count_elements as i32, 1,
            );
