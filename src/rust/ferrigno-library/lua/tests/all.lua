...
-- ferrigno extension tests
dofile('ferrigno_dis.lua')
dofile('ferrigno_functools.lua')
dofile('ferrigno_fmath.lua')
dofile('ferrigno_itertools.lua')
dofile('ferrigno_syntax.lua')
