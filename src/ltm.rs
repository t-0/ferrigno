...
pub struct CallInfo {
    ...
    pub u: LTMC2RustUnnamed_1,
    pub u2: LTMC2RustUnnamed,
    pub nresults: libc::c_short,
    pub callstatus: libc::c_ushort,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LTMC2RustUnnamed {
    pub funcidx: i32,
    pub nyield: i32,
    pub nres: i32,
    pub transferinfo: LTMC2RustUnnamed_0,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LTMC2RustUnnamed_0 {
    pub ftransfer: libc::c_ushort,
    pub ntransfer: libc::c_ushort,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LTMC2RustUnnamed_1 {
    pub l: LTMC2RustUnnamed_3,
    pub c: LTMC2RustUnnamed_2,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LTMC2RustUnnamed_2 {
    pub k: lua_KFunction,
    pub old_errfunc: i64,
...
pub union StackValue {
    pub val: TValue,
    pub tbclist: LTMC2RustUnnamed_4,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LTMC2RustUnnamed_4 {
    pub value_: Value,
    pub tt_: u8,
...
pub struct UpVal {
    ...
    pub tt: u8,
    pub marked: u8,
    pub v: LTMC2RustUnnamed_7,
    pub u: LTMC2RustUnnamed_5,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LTMC2RustUnnamed_5 {
    pub open: LTMC2RustUnnamed_6,
    pub value: TValue,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct LTMC2RustUnnamed_6 {
    pub next: *mut UpVal,
    pub previous: *mut *mut UpVal,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LTMC2RustUnnamed_7 {
    pub p: *mut TValue,
    pub offset: i64,
}
#[derive(Copy, Clone)]
...
pub struct TString {
    ...
    pub shrlen: u8,
    pub hash: u32,
    pub u: LTMC2RustUnnamed_8,
    pub contents: [libc::c_char; 1],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union LTMC2RustUnnamed_8 {
    pub lnglen: u64,
...
pub unsafe extern "C" fn luaT_objtypename(
    ...
    let mut mt: *mut Table = 0 as *mut Table;
    if (*o).tt_ as i32 == 5i32 | (0i32) << 4i32 | (1i32) << 6i32 && {
        mt = (*((*o).value_.gc as *mut GCUnion)).h.metatable;
        !mt.is_null()
    } || (*o).tt_ as i32 == 7i32 | (0i32) << 4i32 | (1i32) << 6i32 && {
        mt = (*((*o).value_.gc as *mut GCUnion)).u.metatable;
        !mt.is_null()
    } {
        ...
        if (*name).tt_ as i32 & 0xf as i32 == 4i32 {
            return ((*((*name).value_.gc as *mut GCUnion)).ts.contents).as_mut_ptr();
        }
    }
    return luaT_typenames_[(((*o).tt_ as i32 & 0xf as i32) + 1i32) as usize];
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn luaT_callTM(
    ...
    (*io1).tt_ = (*io2).tt_;
    let mut io1_0: *mut TValue = &mut (*func.offset(1i32 as isize)).val;
    let mut io2_0: *const TValue = p1;
    (*io1_0).value_ = (*io2_0).value_;
    (*io1_0).tt_ = (*io2_0).tt_;
    let mut io1_1: *mut TValue = &mut (*func.offset(2i32 as isize)).val;
    let mut io2_1: *const TValue = p2;
    (*io1_1).value_ = (*io2_1).value_;
    (*io1_1).tt_ = (*io2_1).tt_;
    let mut io1_2: *mut TValue = &mut (*func.offset(3i32 as isize)).val;
    let mut io2_2: *const TValue = p3;
    (*io1_2).value_ = (*io2_2).value_;
    (*io1_2).tt_ = (*io2_2).tt_;
    (*L).top.p = func.offset(4i32 as isize);
    if (*(*L).ci).callstatus as i32 & ((1i32) << 1i32 | (1i32) << 3i32) == 0 {
        luaD_call(L, func, 0i32);
    } else {
        luaD_callnoyield(L, func, 0i32);
    };
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn luaT_callTMres(
    ...
    let mut result: i64 =
        (res as *mut libc::c_char).offset_from((*L).stack.p as *mut libc::c_char) as i64;
    let mut func: StkId = (*L).top.p;
    let mut io1: *mut TValue = &mut (*func).val;
    let mut io2: *const TValue = f;
    (*io1).value_ = (*io2).value_;
    ...
    (*io1_1).value_ = (*io2_1).value_;
    (*io1_1).tt_ = (*io2_1).tt_;
    (*L).top.p = ((*L).top.p).offset(3i32 as isize);
    if (*(*L).ci).callstatus as i32 & ((1i32) << 1i32 | (1i32) << 3i32) == 0 {
        luaD_call(L, func, 1i32);
    } else {
        luaD_callnoyield(L, func, 1i32);
    }
...
pub unsafe extern "C" fn luaT_trybinTM(
    ...
    if ((callbinTM(L, p1, p2, res, event) == 0) as i32 != 0i32) as i32 as i64 != 0 {
        match event as u32 {
            13 | 14 | 15 | 16 | 17 | 19 => {
                if (*p1).tt_ as i32 & 0xf as i32 == 3i32 && (*p2).tt_ as i32 & 0xf as i32 == 3i32 {
...
pub unsafe extern "C" fn luaT_adjustvarargs(
    ...
    let mut i: i32 = 0;
    let mut actual: i32 = ((*L).top.p).offset_from((*ci).func.p) as i64 as i32 - 1i32;
    let mut nextra: i32 = actual - nfixparams;
    (*ci).u.l.nextraargs = nextra;
    if ((((*L).stack_last.p).offset_from((*L).top.p) as i64
        <= ((*p).maxstacksize as i32 + 1i32) as i64) as i32
        != 0i32) as i32 as i64
        != 0
    {
        luaD_growstack(L, (*p).maxstacksize as i32 + 1i32, 1i32);
    }
    let fresh0 = (*L).top.p;
    (*L).top.p = ((*L).top.p).offset(1);
    ...
    while i <= nfixparams {
        ...
        (*io1_0).value_ = (*io2_0).value_;
        (*io1_0).tt_ = (*io2_0).tt_;
        (*((*ci).func.p).offset(i as isize)).val.tt_ = (0i32 | (0i32) << 4i32) as u8;
        i += 1;
    }
...
pub unsafe extern "C" fn luaT_getvarargs(
    ...
    if wanted < 0i32 {
        wanted = nextra;
        if ((((*L).stack_last.p).offset_from((*L).top.p) as i64 <= nextra as i64) as i32 != 0i32)
            as i32 as i64
            != 0
        {
            let mut t__: i64 = (where_0 as *mut libc::c_char)
                .offset_from((*L).stack.p as *mut libc::c_char)
                as i64;
            if (*(*L).l_G).GCdebt > 0i32 as i64 {
                luaC_step(L);
            }
            luaD_growstack(L, nextra, 1i32);
    ...
    while i < wanted {
        (*where_0.offset(i as isize)).val.tt_ = (0i32 | (0i32) << 4i32) as u8;
        i += 1;
    }
}
